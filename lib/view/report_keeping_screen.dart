...
import 'package:virtual_medical_hub/controlller/report_keeping_screen_controller.dart';

import '../utils/colors.dart';

class ReportKeepingScreen extends GetView<ReportKeepingScreenController>{
  const ReportKeepingScreen({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            editTextField(hint: "Report Name"),
            const SizedBox(height: 14,),
            editTextField(hint: "Laboratory Name"),
            const SizedBox(height: 14,),
            editTextField(hint: "Doctor Name"),
            const SizedBox(height: 14,),
            editTextField(hint: "Result Positive/Negative"),
            const SizedBox(height: 14,),
            Obx(() => dateWidget()),
            const SizedBox(height: 24,),
            submitButton (),
